        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("App Permissions", style: TextStyle(color: Colors.black, fontSize: 21, fontWeight: FontWeight.bold,fontFamily: "Verdana"),),
            ...
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Device Information", style: TextStyle(color: Colors.black, fontSize: 23, fontWeight: FontWeight.bold,fontFamily: "Verdana"),),
                SizedBox(width: 20,),
                Row(
                  children: [
                    Transform.scale(
            ...
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Personal Information", style: TextStyle(color: Colors.black, fontSize: 23, fontWeight: FontWeight.bold,fontFamily: "Verdana"),),
                SizedBox(width: 20,),
                Row(
                  children: [
                    Transform.scale(
            ...
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Analytics and Tracking", style: TextStyle(color: Colors.black, fontSize: 23, fontWeight: FontWeight.bold,fontFamily: "Verdana"),),
                SizedBox(width: 20,),
                Row(
                  children: [
                    Transform.scale(
            ...
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Location Data", style: TextStyle(color: Colors.black, fontSize: 23, fontWeight: FontWeight.bold,fontFamily: "Verdana"),),
                SizedBox(width: 20,),
                Row(
                  children: [
                    Transform.scale(
